...
bool CardFilterCard::_matches_def(const Ref<JigsawContext> &context, enums::CardDef::Card card) const {
	return get_card() == card;
}

bool CardFilterCard::_matches_instance(const Ref<JigsawContext> &context, const Ref<CardInstance> &inst) const {
