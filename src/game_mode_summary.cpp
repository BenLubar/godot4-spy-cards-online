...
Ref<Texture2D> GameModeSummary::get_icon_texture(IconDef::Icon icon) const {
	...
	ERR_FAIL_INDEX_V_MSG(icon - IconDef::Icon::FIRST_CUSTOM, _custom_icons.size(), Ref<Texture2D>(), "icon outside of custom range");

	Ref<IconDef> def = _custom_icons[icon - IconDef::Icon::FIRST_CUSTOM];
