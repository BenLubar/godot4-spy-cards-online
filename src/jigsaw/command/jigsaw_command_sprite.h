#ifndef JIGSAW_COMMAND_SPRITE_H
#define JIGSAW_COMMAND_SPRITE_H

#include "jigsaw/command/jigsaw_command.h"

class JigsawCommandSprite : public JigsawCommand {
	GDCLASS(JigsawCommandSprite, JigsawCommand);

protected:
	static void _bind_methods();

public:
	Type get_type() const override { return SPRITE; }
