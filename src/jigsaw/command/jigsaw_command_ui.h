#ifndef JIGSAW_COMMAND_UI_H
#define JIGSAW_COMMAND_UI_H

#include "jigsaw/command/jigsaw_command.h"

class JigsawCommandUI : public JigsawCommand {
	GDCLASS(JigsawCommandUI, JigsawCommand);

protected:
	static void _bind_methods();

public:
	Type get_type() const override { return UI; }
