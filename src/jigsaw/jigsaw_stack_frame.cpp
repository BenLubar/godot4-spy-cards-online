...
void JigsawStackFrame::_bind_methods() {
	BIND_PROPERTY(Variant::INT, branch);
...
IMPLEMENT_PROPERTY_SIMPLE(JigsawStackFrame, int64_t, branch);
IMPLEMENT_PROPERTY_SIMPLE(JigsawStackFrame, Ref<JigsawCommandList>, commands);
