...
void RecordingRoundPlayerData::_bind_methods() {
	...
	BIND_PROPERTY(Variant::PACKED_INT64_ARRAY, chosen_cards);
...
IMPLEMENT_PROPERTY(RecordingRoundPlayerData, PackedInt64Array, chosen_cards);
IMPLEMENT_PROPERTY(RecordingRoundPlayerData, PackedByteArray, realtime_inputs);
